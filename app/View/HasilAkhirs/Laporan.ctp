			...
			<div class="body" style="border-color:#a0a0a0;">
				<?php echo $this->Form->create("Search",array("onsubmit"=>"return SearchAdvance()","url"=>"","id"=>"SearchAdvance"))?>
					...
					<fieldset>
						...
						<?php
							echo $this->Form->input('Search.profil_jabatan_id', array(
								'label'			=>	array('style' => 'font-size:12px', 'text' => 'Nama Jabatan'),
								'div'			=>	array("class"=>"dataTables_filter"),
								'between'		=>	'<div class="formRight"><span class="span3">',
								'after'			=>	'</span></div>',
								'options'		=>	$profilJabatans,
								'empty'			=>	'Pilih'
							));

							echo $this->Form->input('Search.year', array(
								'label'			=>	array('style' => 'font-size:12px', 'text' => 'Periode'),
								'div'			=>	array("class"=>"dataTables_filter"),
								'between'		=>	'<div class="formRight"><span class="span3">',
								'after'			=>	'</span></div>',
								'type'			=>	'text'

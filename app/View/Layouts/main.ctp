...
//FAVICON
echo $this->Html->meta('icon',$this->webroot."img/apa1.png",array("type"=>"png"));
...
<body>
	...
	<div id="leftSide">
		<div class="logo" style="text-align:center;">
			<a href="<?php echo $settings["cms_url"]?>">
				<img src="<?php echo $this->webroot ?>img/apa.png" alt="" width="100"/>
			</a>
		</div>
	...
	<div id="rightSide">
		<div class="topNav">
			<div class="wrapper">
				<div class="welcome">
					<a href="<?php echo $settings['cms_url']?>Karyawans/View/<?php echo $profile['Karyawan']['id']?>" title="">
						<img src="<?php echo $this->webroot ?>img/userPic.png" alt="" />
					</a>
					<span>
						<?php echo $profile["Karyawan"]["nama"]?>
					</span>
				</div>
				<div class="userNav">
					<ul>

				...
				<fieldset>
					<div class="widget">
						<div class="title">
							...
							<h6>Entri Profil Karyawan</h6>
						</div>
						<?php
							echo $this->Form->input('karyawan_id', array(
								'label'			=> 'Karyawan',
								'div' 			=> 'formRow',
						...
						?>
						<?php
							echo $this->Form->input('profil_jabatan_id', array(
								'label'			=> 'Jabatan',
								'div' 			=> 'formRow',
								'between'		=> '<div class="formRight">',
								'after' 		=> '</div>',
								'options'		=> $jabatannames,
								'error' 		=> array('attributes' => array('wrap' => 'label', 'class' => 'formRight error')),
								'empty' 		=> 'Pilih'
							));
						?>
